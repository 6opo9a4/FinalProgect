...
public class AddDesk1Week extends AppCompatActivity {
    ...
    {
        Intent intent1 = new Intent(AddDesk1Week.this, AddDesk2Week.class);
    ...
    {
        Intent intent1 = new Intent(AddDesk1Week.this, MainActivity.class);
        intent1.putExtra("Lector", 99);
        startActivity(intent1);
    }

    public void MondayAdd(View view)
    {
        Intent intent1 = new Intent(AddDesk1Week.this, LessonForm.class);
